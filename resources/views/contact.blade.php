            ...
            <div class="col-xs-9">
                <div class="panel panel-default" id="tentang">
                    ...
                    <div class="panel-body">
                        Terima kasih sudah mengunjungi website ini, apabila ada pertanyaan bisa hubungi beberapa contact berikut :
                        <br>
                        <br>
                        <ul>
                            <li>No. HP : <b>08123123xxx</b></li>
                            <li>Whatsapp : <b>08123123xxx</b></li>
                            <li>Website : <b><a href="http://naistudio.com" target="_blank">http://naistudio.com</a></b></li>
                        </ul>
                    </div>
